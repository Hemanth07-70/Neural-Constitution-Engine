...
from backend.core.constitution.rule import Rule, RuleAction, Principle
from backend.core.domain.action import Action
from backend.core.domain.enums import VerdictAction, RiskLevel, EnvironmentName
...
from backend.core.evaluator.stages import PipelineStage, PipelineData
...
class TestEvaluationPipeline(unittest.TestCase):
    def setUp(self):
        ...
        self.request = DecisionRequest(
            api_version="nce/v1",
            id=uuid.uuid4(),
            actor=Actor(id="test", type="human"),
            ...
            context=DecisionContext(
                ...
                environment=Environment(name=EnvironmentName.TEST, timestamp=__import__('datetime').datetime.now(__import__('datetime').timezone.utc)),
    ...
    def test_no_matching_rules_fail_closed(self):
    ...
    def test_one_matching_rule(self):
    ...
    def test_multiple_matching_rules_aggregate_risk(self):
    ...
    def test_rule_conflicts_resolution(self):
