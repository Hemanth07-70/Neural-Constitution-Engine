...
from backend.core.domain.enums import ResolutionStrategy, ResultStatus, RiskLevel, Scope, VerdictAction
from backend.core.domain.explanation import DeterminingRule, Explanation, Resolution, Verdict
...
class ExplanationStage(PipelineStage):
    ...
    def execute(
        ...
        status = (
            ...
            if action in (VerdictAction.REQUEST_HUMAN_APPROVAL, VerdictAction.ESCALATE)
            else ResultStatus.FINAL
        )
