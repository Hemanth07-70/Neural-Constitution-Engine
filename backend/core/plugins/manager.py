...
class PluginManager:
    ...
    def __init__(self) -> None:
        ...
        self._registries: dict[Capability, CapabilityRegistry[Any]] = {cap: CapabilityRegistry() for cap in Capability}
            ...
            for cap in plugin.metadata.capabilities:
                try:
                    ...
                    raise PluginRegistrationError(
                        f"Failed to register capability {cap} for plugin {plugin_id}: {e}"
                    ) from e
