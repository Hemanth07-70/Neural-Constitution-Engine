...
class ConstitutionLoader:
    ...
    def load_dict(self, data: dict[str, Any]) -> Constitution:
        ...
        metadata = Metadata(
            ...
            scope=str(metadata_dict.get("scope", "")),
        ...
        if resolution_dict is not None:
            ...
            resolution = Resolution(
                strategy=str(resolution_dict.get("strategy", "")),
                default_verdict=str(resolution_dict.get("default_verdict", "")),
            )
        ...
        for r in rules_list:
            ...
            if isinstance(cond, dict):
                cond = MappingProxyType(cond)
            elif not isinstance(cond, str):
                raise ConstitutionValidationError("Rule condition must be an object or string")
